        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { title: 'New Semester Registration Open', time: '2 hours ago', type: 'system' },
                { title: 'Faculty Training Session Scheduled', time: '5 hours ago', type: 'event' },
                { title: 'System Maintenance Completed', time: 'Yesterday', type: 'system' },
                { title: 'New Course Materials Uploaded', time: '2 days ago', type: 'content' },
              ].map((activity, i) => (
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-2">
              {[
                { title: 'Add New User', icon: 'user-plus' },
                { title: 'Attendance Reports', icon: 'chart' },
                { title: 'Manage Departments', icon: 'building' },
                { title: 'System Settings', icon: 'settings' },
              ].map((item, i) => (
                <button key={i} className="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="w-8 h-8 flex items-center justify-center rounded-full bg-secondary mb-2">
                    {item.icon === 'user-plus' ? (
