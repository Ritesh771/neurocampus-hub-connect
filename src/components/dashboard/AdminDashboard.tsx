            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                {[
                  ...
                  <motion.button 
                    key={i} 
                    className="flex flex-col items-center justify-center p-3 sm:p-4 border rounded-lg hover:bg-gray-50 hover:shadow-md transition-all duration-300 min-w-0"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-primary/10 mb-2 flex-shrink-0">
                      {item.icon === 'user-plus' ? (
                    ...
                    <span className="text-xs text-center font-medium truncate w-full">{item.title}</span>
                  </motion.button>
                ))}
              </div>
            </CardContent>
