...
const BulkUploadPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-2">Bulk Upload Users</h1>
        <p className="text-gray-600">Upload multiple users at once using CSV format</p>
      </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <h4 className="font-medium mb-2">Supported Roles:</h4>
