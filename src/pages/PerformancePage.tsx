        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <Button onClick={handleExportPDF} variant="outline" size="sm" className="flex items-center gap-2 w-full sm:w-auto">
                <Download className="h-4 w-4" />
                Export PDF
              </Button>
              <Button onClick={handleExportCSV} variant="outline" size="sm" className="flex items-center gap-2 w-full sm:w-auto">
                <Download className="h-4 w-4" />
                Export CSV
              </Button>
            </div>
            ...
            <CardContent className="p-0">
              <div className="w-full overflow-x-auto">
                <div className="min-w-[320px] sm:min-w-[500px]">
                  {/* Table Header */}
                  <div className="grid grid-cols-4 gap-2 sm:gap-4 p-3 sm:p-4 bg-gray-50 border-b font-medium text-xs sm:text-sm text-gray-700">
                    <div className="col-span-1">Subject</div>
                    <div className="text-center">Avg Marks</div>
                    ...
                    {subjectPerformance.map((subject, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="grid grid-cols-4 gap-2 sm:gap-4 p-3 sm:p-4 border-b hover:bg-gray-50 transition-colors"
                        >
          ...
          <Card className="w-full">
            <CardContent className="p-3 sm:p-4">
              <div className="text-center space-y-1">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-blue-600">87.2%</p>
          ...
          <Card className="w-full">
            <CardContent className="p-3 sm:p-4">
              <div className="text-center space-y-1">
                ...
                <p className="text-base sm:text-lg font-bold text-green-600">CS-4A</p>
                <p className="text-xs text-gray-500">92% attendance, 85% marks</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="w-full">
            <CardContent className="p-3 sm:p-4">
              <div className="text-center space-y-1">
                ...
                <p className="text-base sm:text-lg font-bold text-red-600">CS-5B</p>
                <p className="text-xs text-gray-500">83% attendance, 75% marks</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="w-full">
            <CardContent className="p-3 sm:p-4">
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-gray-500">Improvement this month</p>
              </div>
            </CardContent>
          </Card>
        </motion.div>
