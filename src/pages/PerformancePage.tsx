                  ...
                  {subjectPerformance.map((subject, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="grid grid-cols-4 gap-4 p-4 border-b hover:bg-gray-50 transition-colors"
                      >
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-green-600">CS-4A</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-red-600">CS-5B</p>
