...
const HODLeavesPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-2">HOD Leave Management</h1>
        <p className="text-gray-600">Review and manage leave requests from department heads</p>
      </motion.div>
